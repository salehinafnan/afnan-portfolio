  ...
  <div className="mt-6 flex flex-wrap gap-2">
    {project.live && (
      <a
        ...
        className={`${pill} border-neutral-950 bg-neutral-950 text-white hover:border-neutral-800 hover:bg-neutral-800`}
      >
    ...
    <a
      ...
      target="_blank"
      rel="noopener noreferrer"
      className={`${pill} border-neutral-200 bg-white text-neutral-700 hover:border-neutral-900 hover:text-neutral-950`}
    >
      ...
      <ul className="mx-auto grid max-w-6xl grid-cols-1 gap-8 md:grid-cols-2 lg:gap-12">
        <li data-reveal className="md:col-span-2">
          <article className="glass-card lift group flex h-full flex-col overflow-hidden rounded-3xl xl:flex-row">
            ...
            <div className="bg-neutral-950 xl:flex xl:w-[56%] xl:shrink-0 xl:items-center">
              <ProjectPreview
            ...
            <div className="flex grow flex-col p-6 sm:p-8 xl:justify-center xl:p-10">
              <p className="mb-3 font-mono text-xs font-medium tracking-widest text-neutral-500 uppercase">Latest project</p>
              <h3 className="mb-3 text-2xl font-semibold tracking-tight text-neutral-950 sm:text-3xl">{featured.title}</h3>
              <p className="mb-6 max-w-2xl text-[0.9375rem] leading-relaxed text-neutral-600">{featured.description}</p>
          ...
          >
            <article className="glass-card lift group flex h-full flex-col overflow-hidden rounded-3xl">
              ...
              <div className="flex grow flex-col p-6 sm:p-8">
                <h3 className="mb-3 text-xl font-semibold tracking-tight text-neutral-950">{project.title}</h3>
                <p className="mb-6 grow text-[0.9375rem] leading-relaxed text-neutral-600">{project.description}</p>
      ...
      <div className="mx-auto mt-20 max-w-6xl sm:mt-24">
            ...
            >
              <article className="glass-card lift group relative flex h-full flex-col rounded-2xl p-6">
                <div className="mb-5 flex items-center gap-3">
                  <FiFolder aria-hidden="true" className="size-5 text-neutral-900" />
                  {repo.team && (
                    <span className="rounded-full border border-neutral-200 bg-neutral-50 px-2.5 py-0.5 text-[0.6875rem] font-medium text-neutral-500">
                      Team project
                    </span>
                  )}
                  <FiArrowUpRight
                    aria-hidden="true"
                    className="ml-auto size-5 text-neutral-400 transition-[color,translate] duration-300 group-hover:translate-x-0.5 group-hover:-translate-y-0.5 group-hover:text-neutral-950"
                  />
                </div>
                <h4 className="mb-2 font-semibold tracking-tight text-neutral-950">
                ...
                <p className="mb-5 grow text-sm leading-relaxed text-neutral-600">{repo.description}</p>
                <ul className="flex flex-wrap gap-x-3 gap-y-1 font-mono text-[0.6875rem] text-neutral-500">
        ...
        <div data-reveal className="mt-10 flex justify-center sm:mt-12">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 rounded-full border border-neutral-200 bg-white px-6 py-3 text-sm font-medium text-neutral-900 transition-colors hover:border-neutral-300 hover:bg-neutral-50"
          >
