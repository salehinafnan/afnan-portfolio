      ...
      <div data-reveal className="mx-auto max-w-4xl">
        <article className="glass-card flex flex-col gap-3 rounded-3xl p-6 transition-colors hover:bg-white/3 sm:p-8 md:flex-row md:gap-8">
          ...
          <div className="md:w-3/4">
            ...
            <p className="mt-3 text-[0.9375rem] leading-relaxed text-pretty text-neutral-400">{EDUCATION.description}</p>
            <div className="mt-4">
            ...
            return (
              ...
              >
                <article className="glass-card flex h-full flex-col rounded-2xl p-6">
                  <Icon aria-hidden="true" className="mb-5 size-6 text-neutral-400" />
                  <h4 className="mb-1 font-semibold tracking-tight text-balance text-neutral-50">{credential.title}</h4>
